...
$sql = "SELECT * FROM teaccher ORDER BY teaccher_id DESC"; // Assuming you have an id column, ordering by newest first
...
<body class="body-admindashboard">
      ...
      ?>
        ...
        <section class="content-admin">
            ...
            <h2  class="view_students_head">Teachers</h2>
                
                <table border="1px">
                    <tr>
                         <th style="padding: 5px;">teacher_id</th>
                        <th style="padding: 5px;">full_name</th>
